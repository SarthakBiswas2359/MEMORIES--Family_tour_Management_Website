        ...
        <section class="features">
            <form  method="POST">
                ...
                <fieldset>
                    ...
                    <div class="forgot">
                        <a href="forgot.html" style="color: black ;font-weight: bold; text-decoration: none;">Forgot
                            Password?</a>
                    </div>
                    ...
                    <br>
                    <h6 style="color: black; text-align: center;">OR</h6>
                    <div class="box-3">
                        <button><a href="signup.html" style="color: black; text-decoration: none;">Create</a></button>
